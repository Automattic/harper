...
use crate::dialects::dialect_enum::DialectFlagsEnum;
...
pub struct DictWordMetadata {
    ...
    /// Words in portuguese are split between masculine and femininetrue
...
impl DictWordMetadata {
    ...
    pub fn or(&self, other: &Self) -> Self {
        ...
        Self {
            ...
            stress: self.stress.or(other.stress),
            gender: self.gender.or(other.gender),
            affix: self.affix.or(other.affix),
        }
    }
...
/// Where in the word is the stress
/// In portuguese, it can only be in one of the last syllables
/// If in the last, the word is an oxitona
/// If in the penultimate, the word is an paroxitona
/// If in the ante penultime, the word is an proparoxitona
#[derive(
    Debug, Hash, Eq, PartialEq, Clone, Copy, EnumIter, Serialize, Deserialize, PartialOrd, Ord, Is,
)]
pub enum Stress {
    Oxitona,
    Paroxitona,
...
pub mod tests {
    ...
    mod dialect {
        use super::super::{EnglishDialect, EnglishDialectFlags};
        use crate::Document;
        use crate::dialects::dialect_trait::DialectFlags;
