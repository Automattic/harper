...
mod tests {
    ...
    fn web_cam() {
        ...
        assert_suggestion_result(test_sentence, test_linter(), expected);
    }
    ...
    fn got_is_not_possessive() {
        assert_lint_count("I got here by car...", test_linter(), 0);
    }

    #[test]
    fn allow_issue_662() {
        assert_lint_count("They are as old as *modern* computers ", test_linter(), 0);
    }

    #[test]
    fn allow_issue_661() {
        assert_lint_count("I may be wrong.", test_linter(), 0);
    }

    #[test]
    fn allow_issue_704() {
        assert_lint_count("Here are some ways to do that:", test_linter(), 0);
    }
    ...
    #[test]
    fn allows_678() {
        assert_lint_count("they can't catch all the bugs.", test_linter(), 0);
    }
    ...
    #[test]
    fn allow_can_not() {
        assert_lint_count("Size can not be determined.", test_linter(), 0);
    }
    ...
    #[test]
    fn allow_issue_1496() {
        assert_no_lints("I am not able to respond to messages.", test_linter());
    }
