...
mod lints {
    ...
    #[test]
    fn eighties() {
        assert_lint_count("in the 80's", test_linter(), 1);
    }

    #[test]
    #[ignore = "wip"]
    fn nineties() {
        assert_lint_count("the 90’s were a bit grungy", test_linter(), 1);
    }

    #[test]
    fn dont_flag_three_digits() {
        assert_no_lints("200's doesn't look like a decade", test_linter());
    }

    #[test]
    fn dont_flag_one_digit() {
        assert_no_lints("0's doesn't look like a decade", test_linter());
    }

    #[test]
    fn dont_flag_not_ending_with_0() {
        assert_no_lints("'77's best month was October", test_linter());
    }
    ...
    fn dont_flag_space_version_numbers_virtualenv_20() {
        assert_no_lints("Clarifying virtualenv 20's -p behavior", test_linter());
    }

    #[test]
    #[ignore = "wip"]
    fn dont_flag_hyphenated_version_numbers_soi_20() {
        assert_no_lints("View soi-20's full-sized avatar.", test_linter());
    }
    ...
    fn dont_flag_lesson_20s_sql_query() {
        assert_no_lints("Lesson 20's SQL Query is too inefficient", test_linter());
    }
    ...
    fn dont_flag_group_40s() {
        assert_no_lints("Group 40's team maths game.", test_linter());
    }
    ...
    fn dont_flag_50s_username() {
        assert_no_lints("View 50's full-sized avatar.", test_linter());
    }
    ...
    fn dont_flag_60_seconds() {
        assert_no_lints("WSL cold startup 60's +", test_linter());
    }
