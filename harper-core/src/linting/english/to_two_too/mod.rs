...
mod tests {
    ...
    fn no_lint_accustomed_to_precision() {
        assert_no_lints(
            "I’m rather accustomed to precision.",
            ToTwoToo::default(),
            crate::languages::LanguageFamily::English,
        );
    }
    ...
    fn no_lint_prone_to_melancholy() {
        assert_no_lints(
            "He wasn’t a man prone to melancholy.",
            ToTwoToo::default(),
            crate::languages::LanguageFamily::English,
        );
    }
    ...
    fn no_lint_superlative_range() {
        assert_no_lints(
            "Sort speeds from slowest to fastest.",
            ToTwoToo::default(),
            crate::languages::LanguageFamily::English,
        );
    }
    ...
    fn no_lint_comparative_range() {
        assert_no_lints(
            "We rank tasks from harder to easier.",
            ToTwoToo::default(),
            crate::languages::LanguageFamily::English,
        );
    }
