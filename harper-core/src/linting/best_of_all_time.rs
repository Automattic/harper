...
mod tests {
    ...
    #[test]
    fn fix_after_best() {
        assert_suggestion_result("And also in the best IDE of all times Visual Studio", BestOfAllTime::default(), "And also in the best IDE of all time Visual Studio", crate::languages::Language::English(crate::EnglishDialect::American));
    }

    #[test]
    fn fix_after_greatest() {
        assert_suggestion_result("This app shows you why Sachin Tendulkar is the greatest cricket of all times, by using interactive stories.", BestOfAllTime::default(), "This app shows you why Sachin Tendulkar is the greatest cricket of all time, by using interactive stories.", crate::languages::Language::English(crate::EnglishDialect::American));
    }

    #[test]
    fn fix_after_biggest() {
        assert_suggestion_result("THIS IS THE BIGGEST QUESTIONS OF ALL TIMES...", BestOfAllTime::default(), "THIS IS THE BIGGEST QUESTIONS OF ALL TIME...", crate::languages::Language::English(crate::EnglishDialect::American));
    }

    #[test]
    fn fix_after_most_influential() {
        assert_suggestion_result("It is an open source project that aggregates multiple lists of \"the best/most influential games of all times\"", BestOfAllTime::default(), "It is an open source project that aggregates multiple lists of \"the best/most influential games of all time\"", crate::languages::Language::English(crate::EnglishDialect::American));
    }
    ...
    fn fix_after_favorite() {
        assert_suggestion_result("Red Dead Redemption 2 is my nr 1 favorite game of all times", BestOfAllTime::default(), "Red Dead Redemption 2 is my nr 1 favorite game of all time", crate::languages::Language::English(crate::EnglishDialect::American));
    }

    #[test]
    fn fix_after_favourite() {
        assert_suggestion_result("Just made this website to show you my favourite movies of all times.", BestOfAllTime::default(), "Just made this website to show you my favourite movies of all time.", crate::languages::Language::English(crate::EnglishDialect::American));
    }
}
