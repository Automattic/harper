...
mod soon_to_be;
pub mod spanish_contextual_punctuation;
pub mod spanish_dequeismo;
pub mod spanish_diacritics;
pub mod spanish_dialects;
pub mod spanish_gender_agreement;
pub mod spanish_homophones;
pub mod spanish_plural_agreement;
pub mod spanish_punctuation;
pub mod spanish_sentence_capitalization;
pub mod spanish_strict_rules;
pub mod spanish_style_and_redundancy;
pub mod spanish_style_tone;
pub mod spanish_subject_verb_agreement;
pub mod spanish_typography;
pub mod spanish_verb_conjugation;
pub use languagetool_rules::LanguageToolRules;
pub use spanish_contextual_punctuation::SpanishContextualPunctuation;
pub use spanish_dequeismo::SpanishDequeismo;
pub use spanish_diacritics::SpanishDiacritics;
pub use spanish_dialects::SpanishDialects;
pub use spanish_gender_agreement::SpanishGenderAgreement;
pub use spanish_homophones::SpanishHomophones;
pub use spanish_plural_agreement::SpanishPluralAgreement;
pub use spanish_punctuation::SpanishPunctuation;
pub use spanish_sentence_capitalization::SpanishSentenceCapitalization;
pub use spanish_strict_rules::SpanishStrictRules;
pub use spanish_style_and_redundancy::SpanishStyleAndRedundancy;
pub use spanish_style_tone::SpanishStyleTone;
pub use spanish_subject_verb_agreement::SpanishSubjectVerbAgreement;
pub use spanish_typography::SpanishTypography;
pub use spanish_verb_conjugation::SpanishVerbConjugation;
mod sought_after;
mod spaces;
pub mod spell_check;
