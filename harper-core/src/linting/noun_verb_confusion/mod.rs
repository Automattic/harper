...
mod tests {
    ...
    fn corrects_good_advise() {
        assert_suggestion_result("Good advise", test_linter(), "Good advice");
    }
    ...
    fn corrects_belief_instead_of_verb() {
        assert_suggestion_result("I belief in you.", test_linter(), "I believe in you.");
    }
    ...
    fn does_not_flag_correct_believe() {
        assert_lint_count("I believe in you.", test_linter(), 0);
    }

    #[test]
    fn does_not_flag_correct_breath() {
        assert_lint_count("Take a deep breath.", test_linter(), 0);
    }
    ...
    fn allow_to_emphasis_at_end() {
        assert_lint_count("Changes literal underscores to emphasis", test_linter(), 0);
    }
    ...
    fn ignores_effect_noun_phrase() {
        assert_lint_count("The effect your plan had was dramatic.", test_linter(), 0);
    }

    #[test]
    fn ignores_effect_as_result_noun() {
        assert_lint_count("The effect was immediate and obvious.", test_linter(), 0);
    }
    ...
    fn ignores_side_effects_usage() {
        assert_lint_count("Side effects may include mild nausea.", test_linter(), 0);
    }
    ...
    fn ignores_psychology_usage() {
        assert_lint_count("The patient's affect is flat.", test_linter(), 0);
    }
    ...
    fn does_not_flag_correct_effect_noun() {
        assert_lint_count("The placebo effect can be powerful.", test_linter(), 0);
    }

    #[test]
    fn does_not_flag_sound_effects() {
        assert_lint_count("Sound effects were added in post.", test_linter(), 0);
    }
    ...
    #[test]
    fn issue_1996() {
        assert_no_lints("Avoid effects outside of functions.", test_linter());
    }
    ...
    fn no_flag_side_effects_in_functions() {
        assert_lint_count("Avoid side effects in your functions.", test_linter(), 0);
    }

    #[test]
    fn no_flag_this_change_has_no_side_effects() {
        assert_lint_count("This change has no side effects.", test_linter(), 0);
    }
