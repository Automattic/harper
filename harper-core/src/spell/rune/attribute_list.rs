...
use crate::{CharString, CharStringExt, LexemeMetadata, Span};
...
impl AttributeList {
    ...
    pub fn expand_annotated_word(&self, annotated_word: AnnotatedWord, word_map: &mut WordMap) {
        ...
        let mut base_metadata = LexemeMetadata::default();
        ...
        for attr in &annotated_word.annotations {
            ...
            let mut new_words: HashMap<CharString, LexemeMetadata> = HashMap::new();
