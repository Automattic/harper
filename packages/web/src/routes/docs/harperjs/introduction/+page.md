...
It can be imported [natively in a browser](./CDN), through [npm](https://www.npmjs.com/package/harper.js) and [consumed in Node.js](./node), or [bundled into a Chrome extension](./chrome-extension).
