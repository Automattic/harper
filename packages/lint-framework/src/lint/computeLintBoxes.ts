...
function resolveGoogleDocsSpan(currentSource: string, lint: UnpackedLint): UnpackedSpan | null {
...
function getGoogleDocsHighlightRects(target: HTMLElement, span: Span): DOMRect[] {
