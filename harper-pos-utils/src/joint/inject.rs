...
const HEAD_NOUNS: &[&str] = &[
    "song", "garden", "scent", "crops", "apples", "code", "report", "notes", "fields", "stories",
    "music", "budget", "schedule", "designs", "houses",
];
const ADJS: &[&str] = &[
    "elusive",
    "stiff",
...
const CONTROL_VERBS: &[&str] = &[
    "need", "forgot", "want", "tried", "agreed", "refused", "hoped", "decided", "planned",
    "managed", "promised", "offered", "started", "learned",
];
/// Bare (base-form) verbs that follow a control verb.
const BARE_VERBS: &[&str] = &[
    "talk", "send", "meet", "help", "write", "call", "leave", "finish", "answer", "get", "read",
    "build", "fix", "speak", "plan", "review",
];
...
const EA_ATTR_NOUNS: &[&str] = &[
    "sound", "employee", "customer", "policy", "software", "student", "house", "market", "user",
    "team", "network", "product",
];
...
const EA_SUBJECTS: &[&str] = &[
    "policy", "outage", "decision", "rollout", "change", "update", "merger", "delay", "shortage",
    "redesign", "ruling", "tariff",
];
const EA_VERBS_S: &[&str] = &[
    "effects", "affects", "shapes", "alters", "drives", "shifts", "guides", "boosts", "harms",
    "limits", "reshapes", "disrupts",
];
...
const MP_HEAD_A: &[&str] = &[
    "lounge", "meeting", "report", "schedule", "garden", "office", "novel", "budget", "handbook",
    "review", "notebook", "contract", "survey",
];
...
fn templates() -> Vec<Vec<(Cell, UPOS, bool)>> {
    ...
    vec![
        ...
        vec![
            (Fixed("We"), PRON, true),
            (Fixed("heard"), VERB, false),
            (Fixed("the"), DET, true),
            (Pool(PLURAL_NOUNS), NOUN, true),
            (Pool(HEAD_NOUNS), NOUN, true),
            (Fixed("drifting"), VERB, false),
            (Fixed("across"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("quiet"), ADJ, true),
            (Fixed("valley"), NOUN, true),
            (Fixed("after"), ADP, false),
            (Fixed("dawn"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        vec![
            (Fixed("The"), DET, true),
            (Pool(PLURAL_NOUNS), NOUN, true),
            (Pool(HEAD_NOUNS), NOUN, true),
            (Fixed("near"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("river"), NOUN, true),
            (Fixed("looked"), VERB, false),
            (Fixed("unusually"), ADV, false),
            (Fixed("calm"), ADJ, false),
            (Fixed("this"), DET, true),
            (Fixed("year"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        // "a" determiner (fixes possessive_noun "a teachers lounge").
        vec![
            (Fixed("Every"), DET, true),
            (Fixed("office"), NOUN, true),
            (Fixed("needs"), VERB, false),
            (Fixed("a"), DET, true),
            (Pool(MP_PLURAL_A), NOUN, true),
            (Pool(MP_HEAD_A), NOUN, true),
            (Fixed("for"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("whole"), ADJ, true),
            (Fixed("team"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        ...
        vec![
            ...
            (Pool(MP_PLURAL_A), NOUN, true),
            (Pool(MP_HEAD_A), NOUN, true),
            (Fixed("impressed"), VERB, false),
            (Fixed("every"), DET, true),
            (Fixed("visitor"), NOUN, true),
            (Fixed("at"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("county"), NOUN, true),
            (Fixed("fair"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        ...
        vec![
            (Fixed("The"), DET, true),
            (Pool(ADJS), ADJ, true),
            (Pool(SUBJECTS), NOUN, true),
            (Pool(VERBS_S), VERB, false),
            (Fixed("the"), DET, true),
            (Pool(OBJECTS), NOUN, true),
            (Fixed("more"), ADV, false),
            (Fixed("than"), SCONJ, false),
            (Fixed("anyone"), PRON, false),
            (Fixed("had"), AUX, false),
            (Fixed("expected"), VERB, false),
            (Fixed("."), PUNCT, false),
        ],
        vec![
            (Fixed("Every"), DET, true),
            (Fixed("season"), NOUN, true),
            (Fixed("the"), DET, true),
            (Pool(SUBJECTS), NOUN, true),
            (Fixed("quietly"), ADV, false),
            (Pool(VERBS_S), VERB, false),
            (Fixed("the"), DET, true),
            (Pool(OBJECTS), NOUN, true),
            (Fixed("across"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("entire"), ADJ, true),
            (Fixed("region"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        // tight bare NOUN + -s VERB + bare NOUN (fixes weir::wildcard "homework tempts teachers").
        vec![
            (Pool(WR_BARE_NOUNS), NOUN, true),
            (Pool(WR_VERBS_S), VERB, false),
            (Pool(WR_BARE_NOUNS), NOUN, true),
            (Fixed("far"), ADV, false),
            (Fixed("more"), ADV, false),
            (Fixed("than"), SCONJ, false),
            (Fixed("most"), ADJ, true),
            (Fixed("parents"), NOUN, true),
            (Fixed("would"), AUX, false),
            (Fixed("ever"), ADV, false),
            (Fixed("admit"), VERB, false),
            (Fixed("."), PUNCT, false),
        ],
        // ===== Family 3: control verb + bare verb (missing "to") ============
        vec![
            (Fixed("She"), PRON, true),
            (Pool(CONTROL_VERBS), VERB, false),
            (Pool(BARE_VERBS), VERB, false),
            (Fixed("the"), DET, true),
            (Fixed("report"), NOUN, true),
            (Fixed("before"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("upcoming"), ADJ, true),
            (Fixed("deadline"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        vec![
            (Fixed("We"), PRON, true),
            (Pool(CONTROL_VERBS), VERB, false),
            (Pool(BARE_VERBS), VERB, false),
            (Fixed("about"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("issue"), NOUN, true),
            (Fixed("at"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("next"), ADJ, true),
            (Fixed("meeting"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        vec![
            (Fixed("He"), PRON, true),
            ...
            (Pool(BARE_VERBS), VERB, false),
            (Fixed("the"), DET, true),
            (Fixed("file"), NOUN, true),
            (Fixed("to"), ADP, false),
            (Fixed("his"), DET, true),
            (Fixed("manager"), NOUN, true),
            (Fixed("early"), ADV, false),
            (Fixed("that"), DET, true),
            (Fixed("morning"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        // ===== Family 4: "way to[o] <adj>" ==================================
        vec![
            (Fixed("That"), DET, true),
            (Fixed("plan"), NOUN, true),
            (Fixed("is"), AUX, false),
            (Fixed("way"), ADV, false),
            (Fixed("to"), PART, false),
            (Pool(WAY_ADJS), ADJ, false),
            (Fixed("for"), ADP, false),
            (Fixed("our"), DET, true),
            (Fixed("current"), ADJ, true),
            (Fixed("budget"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        vec![
            (Fixed("You"), PRON, true),
            (Fixed("always"), ADV, false),
            (Fixed("drive"), VERB, false),
            (Fixed("way"), ADV, false),
            (Fixed("to"), PART, false),
            (Pool(WAY_ADJS), ADJ, false),
            (Fixed("on"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("narrow"), ADJ, true),
            (Fixed("mountain"), NOUN, true),
            (Fixed("road"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        // ===== Family 5: "Its" + past/participle VERB =======================
        vec![
            (Fixed("Its"), PRON, true),
            (Pool(ITS_VERBS), VERB, false),
            (Fixed("after"), ADP, false),
            (Fixed("a"), DET, true),
            (Fixed("famous"), ADJ, true),
            (Fixed("explorer"), NOUN, true),
            (Fixed("from"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("far"), ADJ, true),
            (Fixed("north"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        ...
        vec![
            (Fixed("The"), DET, true),
            (Pool(EA_SUBJECTS), NOUN, true),
            (Pool(EA_VERBS_S), VERB, false),
            (Fixed("our"), DET, true),
            (Pool(EA_ATTR_NOUNS), NOUN, true),
            (Pool(EA_HEAD_NOUNS), NOUN, true),
            (Fixed("more"), ADV, false),
            (Fixed("than"), SCONJ, false),
            (Fixed("anyone"), PRON, false),
            (Fixed("had"), AUX, false),
        ...
        vec![
            (Pool(EA_ATTR_NOUNS), NOUN, true),
            (Pool(EA_HEAD_NOUNS), NOUN, true),
            (Fixed("were"), AUX, false),
            (Fixed("added"), VERB, false),
            (Fixed("during"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("final"), ADJ, true),
            (Fixed("editing"), NOUN, true),
            (Fixed("pass"), NOUN, true),
            (Fixed("last"), ADJ, true),
            (Fixed("week"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        ...
        vec![
            ...
            (Pool(EA_ATTR_NOUNS), NOUN, true),
            (Pool(EA_HEAD_NOUNS), NOUN, true),
            (Fixed("remains"), VERB, false),
            (Fixed("stuck"), ADJ, false),
            (Fixed("in"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("same"), ADJ, true),
            (Fixed("broken"), ADJ, true),
            (Fixed("state"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        // PROTECTIVE: result-noun + predicative ADJ.
        vec![
            (Fixed("The"), DET, true),
            (Fixed("overall"), ADJ, true),
            (Fixed("outcome"), NOUN, true),
            (Fixed("was"), AUX, false),
            (Pool(EA_PRED_ADJS), ADJ, false),
            (Fixed("and"), CCONJ, false),
            (Fixed("clearly"), ADV, false),
            (Fixed("visible"), ADJ, false),
            (Fixed("to"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("whole"), ADJ, true),
            (Fixed("team"), NOUN, true),
        ...
        vec![
            (Fixed("The"), DET, true),
            (Pool(EA_SUBJECTS), NOUN, true),
            (Fixed("will"), AUX, false),
            (Fixed("influence"), VERB, false),
            (Fixed("our"), DET, true),
            (Fixed("quarterly"), ADJ, true),
            (Fixed("revenue"), NOUN, true),
            (Fixed("quite"), ADV, false),
            (Fixed("significantly"), ADV, false),
            (Fixed("this"), DET, true),
            (Fixed("year"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        ...
        vec![
            (Fixed("The"), DET, true),
            (Fixed("firmware"), NOUN, true),
            (Fixed("is"), AUX, false),
            (Fixed("all"), ADV, false),
            (Fixed("ready"), ADJ, false),
            (Pool(WR_PRED_ADJS), ADJ, false),
            (Fixed("on"), ADP, false),
            (Fixed("every"), DET, true),
            (Fixed("supported"), ADJ, true),
            (Fixed("device"), NOUN, true),
            (Fixed("today"), NOUN, false),
            (Fixed("."), PUNCT, false),
        ],
        // each_others: literal "each others" + NOUN head.
        vec![
            (Fixed("They"), PRON, true),
            (Fixed("reviewed"), VERB, false),
            (Fixed("each"), DET, true),
            (Fixed("others"), PRON, true),
            (Pool(WR_HEAD_NOUNS), NOUN, true),
            (Fixed("before"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("final"), ADJ, true),
            (Fixed("release"), NOUN, true),
            (Fixed("went"), VERB, false),
            (Fixed("live"), ADV, false),
            (Fixed("."), PUNCT, false),
        ],
        // there_to_their: literal "there" + NOUN head (possessive misuse).
        vec![
            (Fixed("They"), PRON, true),
            (Fixed("left"), VERB, false),
            (Fixed("there"), ADV, false),
            (Pool(WR_HEAD_NOUNS), NOUN, true),
            (Fixed("near"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("front"), ADJ, true),
            (Fixed("entrance"), NOUN, true),
            (Fixed("this"), DET, true),
            (Fixed("morning"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        ...
        vec![
            (Fixed("We"), PRON, true),
            (Fixed("bought"), VERB, false),
            (Pool(WR_COLORS), NOUN, true),
            (Fixed("colored"), ADJ, true),
            (Pool(WR_HEAD_NOUNS), NOUN, true),
            (Fixed("for"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("spring"), NOUN, true),
            (Fixed("festival"), NOUN, true),
            (Fixed("parade"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        // makeup: literal "make up" preceded by determiner + attributive ADJ.
        vec![
            (Fixed("Her"), DET, true),
            (Pool(WR_ATTR_ADJS), ADJ, true),
            (Fixed("make"), VERB, false),
            (Fixed("up"), ADP, false),
            (Fixed("looked"), VERB, false),
            (Fixed("perfect"), ADJ, false),
            (Fixed("for"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("evening"), NOUN, true),
            (Fixed("gala"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        // tomorrow_possessive: literal "Tomorrows" + NOUN head (protect).
        vec![
            (Fixed("Tomorrows"), NOUN, true),
            (Pool(WR_HEAD_NOUNS), NOUN, true),
            (Fixed("starts"), VERB, false),
            (Fixed("promptly"), ADV, false),
            (Fixed("at"), ADP, false),
            (Fixed("nine"), NUM, true),
            (Fixed("in"), ADP, false),
            (Fixed("the"), DET, true),
            (Fixed("main"), ADJ, true),
            (Fixed("hall"), NOUN, true),
            (Fixed("."), PUNCT, false),
        ],
        // attributive ADJ inside an NP (protects missing_determiner, thieve_noun).
        vec![
            (Fixed("Please"), INTJ, false),
            (Fixed("send"), VERB, false),
            (Fixed("the"), DET, true),
            (Pool(WR_ATTR_ADJS), ADJ, true),
            (Fixed("report"), NOUN, true),
            (Fixed("to"), ADP, false),
        ...
        vec![
            ...
            (Fixed("next"), ADJ, true),
            (Fixed("release"), NOUN, true),
            (Fixed("goes"), VERB, false),
            (Fixed("out"), ADP, false),
            (Fixed("tonight"), NOUN, false),
            (Fixed("."), PUNCT, false),
        ],
    ]
}
...
mod tests {
    ...
    fn generates_varied_well_formed_examples() {
        ...
        let song = sents
            .iter()
            .zip(tags.iter())
            .find(|(s, _)| s.windows(2).any(|w| w[0] == "birds" && w[1] == "song"));
        if let Some((s, t)) = song {
            ...
            assert_eq!(
                t[i - 1],
                Some(UPOS::NOUN),
                "the plural modifier is a NOUN too"
            );
        }
        ...
        let ctrl = sents
            .iter()
            .zip(tags.iter())
            .find(|(s, _)| s.first().map(|w| w == "She").unwrap_or(false));
        ...
        let allready = sents
            .iter()
            .zip(tags.iter())
            .find(|(s, _)| s.windows(2).any(|w| w[0] == "all" && w[1] == "ready"));
        if let Some((s, t)) = allready {
            let i = s.iter().position(|w| w == "ready").unwrap();
            assert_eq!(
                t[i + 1],
                Some(UPOS::ADJ),
                "the word after 'all ready' is an ADJ"
            );
        }
    }
}
